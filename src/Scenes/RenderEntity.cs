...
class RenderEntity : Godot.Sprite
{
    ...
    void SetShaderValues()
    {
        ...
        {
            var r = (ownerComponent.ownedBy == (User)GameSystem.Game.Player.GetID()) ? Options.FriendlyColour.R : Options.EnemyColour.R;
            var g = (ownerComponent.ownedBy == (User)GameSystem.Game.Player.GetID()) ? Options.FriendlyColour.G : Options.EnemyColour.G;
            var b = (ownerComponent.ownedBy == (User)GameSystem.Game.Player.GetID()) ? Options.FriendlyColour.B : Options.EnemyColour.B;
    ...
    void DrawSelected()
    {
        ...
        var friendly = (User)GameSystem.Game.Player.GetID();
